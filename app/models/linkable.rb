class Linkable < ApplicationRecord
  ...
  has_many :a_links, class_name: 'Link', as: :linkable_a
  has_many :b_links, class_name: 'Link', as: :linkable_b
  ...
  def links_to
    ...
    a_linked_documents.all + b_linked_documents.all + a_linked_highlights.all + b_linked_highlights.all
  end

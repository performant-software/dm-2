...
const blockquoteDOM = ['blockquote', 0]; const hrDOM = ['hr'];
const preDOM = ['pre', ['code', 0]]; const
  brDOM = ['br'];
...
const emDOM = ['em', 0]; const strongDOM = ['strong', 0]; const
  codeDOM = ['code', 0];

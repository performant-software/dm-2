    ...
    return (
      <Draggable handle=".search-popup-drag-handle" bounds="parent">
        <Paper
          zDepth={4}
          style={{
            position: 'absolute', top: `${dialogStartPosition.y}px`, left: `${dialogStartPosition.x}px`, zIndex: dialogStartPosition.z,
          }}
        >
          <ResizableBox width={300} height={300} minConstraints={[200, 120]} maxConstraints={[500, 800]}>
            <div style={{
              width: '100%', height: '100%', display: 'flex', flexDirection: 'column', overflowY: 'hidden',
            }}
            >
